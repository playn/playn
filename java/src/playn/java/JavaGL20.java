...
final class JavaGL20 implements playn.core.gl.GL20 {
	...
	public void glVertexAttrib2fv(int indx, float[] values, int offset) {
		GL20.glVertexAttrib2f(indx, values[indx + offset], values[indx + 1
				+ offset]);
	}

	@Override
	public void glVertexAttrib3fv(int indx, float[] values, int offset) {
		GL20.glVertexAttrib3f(indx, values[indx + offset], values[indx + 1
				+ offset], values[indx + 2 + offset]);
	}

	@Override
	public void glVertexAttrib4fv(int indx, float[] values, int offset) {
		GL20.glVertexAttrib4f(indx, values[indx + offset], values[indx + 1
				+ offset], values[indx + 2 + offset], values[indx + 3 + offset]);
	}
