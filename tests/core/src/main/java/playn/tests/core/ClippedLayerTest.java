...
public class ClippedLayerTest extends Test {
  ...
  protected void addClippedLayers () {
    ...
    Texture cirtex = circle.toTexture();
    ...
    Texture saustex = sausage.toTexture();
