...
public class RoboWebSocket implements Net.WebSocket {

  private final WebSocketClient socket;

  public RoboWebSocket(final Exec exec, String uri, final Listener listener) {
    URI juri = null;
    try {
      juri = new URI(uri);
    ...
    socket = new WebSocketClient(juri, new Draft_6455()) {
