 ...
 * <p> Since all buffer impl classes are package private (except DirectByteBuffer), this factory is
 * the only entrance to access buffer functions from outside of the impl package. </p>
 */
