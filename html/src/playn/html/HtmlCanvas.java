...
public class HtmlCanvas extends Canvas {
  ...
  @Override public Canvas clip(Path path) {
  ...
  @Override public Canvas fillRect(float x, float y, float w, float h) {
    ctx.fillRect(x, y, w, h);
    isDirty = true;
    return this;
  }

  @Override public Canvas fillRoundRect(float x, float y, float w, float h, float radius) {
  ...
  @Override public Canvas setCompositeOperation(Canvas.Composite composite) {
  ...
  @Override public Canvas setStrokeWidth(float w) {
    ctx.setLineWidth(w);
    return this;
  }
  ...
  @Override public Canvas strokePath(Path path) {
    assert path instanceof HtmlPath;
    ((HtmlPath) path).replay(ctx);
    ctx.stroke();
    isDirty = true;
  ...
  @Override public Canvas strokeRect(float x, float y, float w, float h) {
    ctx.strokeRect(x, y, w, h);
    isDirty = true;
    return this;
  }

  @Override public Canvas strokeRoundRect(float x, float y, float w, float h, float radius) {
    addRoundRectPath(x, y, w, h, radius);
    ctx.stroke();
    isDirty = true;
    return this;
  ...
  @Override public Canvas transform(float m11, float m12, float m21, float m22, float dx, float dy) {
  ...
  @Override protected Context2d gc() {
    return ctx;
  }
