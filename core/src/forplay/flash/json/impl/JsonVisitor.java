...
import forplay.flash.json.impl.JsonContext;

/**
 * A visitor for JSON objects. For each unique JSON datatype, a callback is
 * invoked with a {@link forplay.flash.json.impl.JsonContext}
...
class JsonVisitor {
   ...
   */
  public void visit(boolean bool, forplay.flash.json.impl.JsonContext ctx) {
  }
