...
public class FlashStorage implements Storage {
  ...
  /* (non-Javadoc)
   * @see playn.core.Storage#getItem(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see playn.core.Storage#isPersisted()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see playn.core.Storage#removeItem(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see playn.core.Storage#setItem(java.lang.String, java.lang.String)
   */
  @Override
