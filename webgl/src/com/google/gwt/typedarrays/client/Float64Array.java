...
public class Float64Array extends ArrayBufferView {
   ...
   * @see #create(ArrayBuffer, int, int)
   */
  public static final native Float64Array create(ArrayBuffer buffer, int byteOffset) /*-{
   ...
   */
  public static final native Float64Array create(ArrayBuffer buffer, int byteOffset, int length) /*-{
